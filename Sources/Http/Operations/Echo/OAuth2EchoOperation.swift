...
/// Get OAuth2 Echo Operation
internal class GetOAuth2EchoOperation: BaseOperation<Echo> {
...
/// Post OAuth2 Echo Operation
internal class PostOAuth2EchoOperation: BaseOperation<Echo> {
    fileprivate let resource: () -> HTTPResource<Echo>
    fileprivate var callback: UpvestCompletion<Echo>
